...
class MainRouterGame extends FlameGame {
  ...
  final List<FruitModel> fruits = [
    FruitModel(image: "singkamas.png"),
    FruitModel(image: "talong.png"),
    FruitModel(image: "sigarilyas.png"),
    FruitModel(image: "mani.png"),
    FruitModel(image: "sitaw.png"),
    FruitModel(image: "bataw.png"),
    FruitModel(image: "patani.png"),
    FruitModel(image: "kundol.png"),
    FruitModel(image: "patola.png"),
    FruitModel(image: "upo.png"),
    FruitModel(image: "kalabasa.png"),
    FruitModel(image: "labanos.png"),
    FruitModel(image: "mustasa.png"),
    FruitModel(image: "sibuyas.png"),
    FruitModel(image: "kamatis.png"),
    FruitModel(image: "bawang.png"),
    FruitModel(image: "luya.png"),
    FruitModel(image: "linga.png"),
